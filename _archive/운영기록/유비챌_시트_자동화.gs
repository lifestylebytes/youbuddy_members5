...
const SPOON = [
  ...
  ['Day 09', '오늘 <결론은 아직 모르는데 신호만 읽는> 표현들이었죠 :)\n여기에 딱 붙는 말 하나 더! 바로 read the tea leaves입니다.\n아직 결과는 없지만, 초기 신호를 보고 앞을 점쳐볼 때 정말 많이 써요.\n\n"What are the tea leaves telling you?"\n(지금 신호로는 어떻게 읽혀요?)\n"Reading the tea leaves, I\'d say the deal closes next month."\n(신호를 보면 다음 달엔 성사될 것 같아요.)\n\n즉, leading indicator는 앞서 움직이는 "지표 자체", read the tea leaves는 그 신호를 "해석해보는" 표현!\n둘이 같이 기억해두면 실무에서 진짜 유용하답니다 👍'],
