...
function 한번에_실행() {
  ...
  step('단어 복습 리마인드 행', function () { addVocabReviewRows(); });
...
const OPS_MSGS = [
  ['day 04', '당일 미팅 알림 + 참여자 조사', '프리미엄 · 미팅 당일 (Day 4/9/14/19) 저녁 · 버디 · 8/20 실발송 검증본', '오늘 밤 9시, Week {N} 미팅이에요! 🎥\n🗓 오늘 밤 9:00~10:00 · Google Meet\n{미트 링크}\n오늘은 {테마} 특집!\n- 근황 check!\n{① ② ③ 순서 나열}\n(오늘 발표: {@발표자} 🎤)\n오늘 하루는 이렇게만 챙기시면 돼요 :)\n① 오늘 학습·인증은 평소처럼! (미팅 전에 끝내두면 마음이 편해요 ㅎㅎ)\n② 이번 주에 쓴 내 문장 1개 골라오기 (미팅에서 읽고, 왜 골랐는지 한 마디)\n③ 이번 주 단어 가볍게 훑어오기 (퀴즈 있어요~ 막히면 힌트 드리니 부담 노노)\n(앱 홈 <미팅 전 할 일> 카드에서 체크할 수 있어요)\n과제 초안/녹음 아직이시면 지금 올려주셔도 늦지 않아요!\n📌 참석 가능하신 분은 이모지 눌러주세요!\n못 오시는 분들을 위해 녹화본도 남겨드릴게요 :)']
  ...
  ['day 10', '주간 테스트 2 + 절반 지점 격려', '양 톡방 · Day 10 · 버디 · 8/21 실발송본', '벌써 절반 왔네요! 🙌\n2주 동안 표현 30개나 써보셨습니다!!! 그중 몇 개는 이미 입에 붙으셨을 거예요.\n아직 안 떠오르는 게 더 많아도 정상이에요. Day 1~10은 원래 그렇습니다.\n지금부터가 진짜인데요,\n통계상 둘째~셋째 주가 제일 고비예요. 미리 말씀드릴게요 💀\n완벽하게 하려고 하지 마시고, 딱 한 문장만 채운다는 마음으로 오세요. 그게 쌓여서 완주가 됩니다 :) 자 드디어 금요일!! 좋은 하루 보내세요! 약속~!!!\n\n(운영 메모: Day 5/10/15 에는 주간 테스트 요청을 이 격려와 한 메시지로 묶는다. 앱 [내 학습] → 이번 주 카드 → 10분.)']
  ...
  ['day 05', '(주말·토) 주차 랩업 + 다음 주 예고', '양 톡방 · 토 14:00 · 버디 · 8/22 실발송본 · 매주 재사용', '여러분~~, {N}주가 지났습니다! 🎉\n그리고 놀라운 사실…!\nDay 1부터 Day {마지막Day}까지 하루도 안 빠지신 분이 {개근 인원}분이세요.\n{N}주 연속으로 매일 뭔가를 한다는 거… 진짜 어려운 일이잖아요?!\n그거 해내신 겁니다 👏\n\n그리고 빠진 날이 있는 분들께도 꼭 드리고 싶은 말이,\n유비챌은 마감이 없어요. ㅎㅎ\n지금 채워도 그날 인증은 가능해요~! (보드에 베이지색으로 표시)\n주말에 한두 개만 채워두시면 다음 주가 훨씬 가벼워져요 :)\n→ 보상은 18일 이상 채워주셔야 pdf 나갑니다!\n\n📌 주말에 딱 두 가지만!\n1) <Week {N} 진짜 외우기> 아직이시면 10분만 (앱 [내 학습])\n   이번엔 자주 틀린 표현을 앱이 먼저 짚어줘요.\n   "오답 3회 · 자주 틀려요" 이런 식으로요!\n2) 빠진 날 있으면 하나만 채우기\n\n다음 주 얘기도 살짝 해드리면…\n{다음 주차}주차는 <{다음 주 테마}>예요.\n{테마 한 줄 설명}\n솔직히 제일 쓸 일 많은 표현들입니다 ㅎㅎ\n\n{3주차 예고 때만 넣기: 그리고 통계상 3주차가 제일 고비예요.\n그래서 미리 약속 하나 드릴게요.\n힘들면 그날은 1번 단어 하나만 하세요. 그것도 인증입니다.}\n\n여기까지 온 분들은 이미 습관이 절반 넘게 잡히신 거예요.\n푹 쉬시고 월요일에 만나요 🧡\n\n(운영 메모: 개근 인원은 Claude 에게 물어 실제 숫자로. 추정치 금지. 8/22 기준 Day1~10 개근 12명.\n늦참 안내는 "마감 없음 + 보드 베이지색" 과 "18일 이상이어야 PDF" 를 항상 같이. 하나만 쓰면 오해가 생긴다.)']
  ...
  ['day 05', '미팅 다음날 통합 공지 발송 · 녹화본 링크 넣어서 (프리미엄)', '프리미엄 · 금 08:00 · 버디 · 8/21 실발송본 (5블록 구조)', '어젯밤 미팅 정말 고생 많으셨어요 🧡\nWeek {N} 후속으로 정리해서 드릴게요!\n━━━━━━━━━━\n📹 Week {N} 미팅 녹화본\n{드라이브 링크}\n못 오신 분들은 이걸로 보시면 돼요.\n앱 회의록 페이지의 [📑 미팅 슬라이드 보기]로 자료도 같이 보시면 좋아요.\n━━━━━━━━━━\n📌 그리고 오늘 꼭 해주셨으면 하는 것!\n이번 주 5일 다 채우신 분들은 <Week {N} 진짜 외우기>가 열렸어요.\n앱 [내 학습]에서 이번 주 카드를 눌러주세요. 10분이면 끝납니다!\n떠올리기 → 기억 안 나는 것만 체크 → 체크한 것만 복습\n프리미엄은 <내 문장>으로도 시험 볼 수 있어요.\n아침 1번, 저녁 1번이면 기가 막히게 외워집니다 :)\n━━━━━━━━━━\n📖 어제 나온 질문, 설명서에 정리해뒀어요\nhttps://youbuddy.co.kr/8th/#help\n목차에서 [🎤 8기 미팅 Q&A] 누르시면 바로 가요.\n이번엔 {@질문한 멤버} 님의 굿 퀘스쳔~! <{이번 주 질문 제목}>을 추가했어요.\n{답변 핵심 3~4개 나열}\n━━━━━━━━━━\n✨ 앱 업데이트 {N}가지\n{업데이트 항목 나열 · 기능명 + 어디서 어떻게 쓰는지}\n(새로고침 한 번 해주셔야 보여요~)\n━━━━━━━━━━\n🎯 이번 주 과제, 앱 홈에 넣어뒀어요\n앱 홈 <내 목표> 아래에서 확인하실 수 있어요.\n\n(운영 메모: 블록 5개 = 녹화본 · 주간 테스트 요청 · Q&A 등록 · 앱 업데이트 · 과제. 질문 준 멤버는 이름 태그로 크레딧.)']
  ...
  ['day 03', '단어 복습 리마인드 ① (Day 3 · 습관 심기)', '양 톡방 · Day 03 저녁 · 버디 · 복습 리마인드 시리즈', '벌써 표현이 9개 쌓였어요! :)\n지금은 적어 보여도 다음 주엔 훅 늘어납니다 ㅎㅎ\n\n그래서 지금부터 습관 하나만 만들어보실래요?\n<b>하루 두 번, 단어시험 다시 보기</b>예요.\n한 번은 아침에, 한 번은 자기 전에!\n(이미 인증을 완료한 후라면, 인증에는 영향을 주지 않습니다)\n\n앱 [내 학습] > 맨 아래 > <오늘 인증한 내용 다시 보기> > <단어시험 다시 보기>\n\n한 번 더 보는 게 새로 외우는 것보다 훨씬 빨라요 :)'],
  ['day 05', '단어 복습 리마인드 ② (Day 5 · 주말 활용)', '양 톡방 · Day 05 저녁 · 버디 · 복습 리마인드 시리즈', '이번 주 표현 15개, 다 기억나세요? 🤔\n솔직히 다 안 나는 게 정상이에요 ㅎㅎ\n\n주말에 딱 5분만 써보세요.\n앱 [내 학습] > 맨 아래 > <오늘 인증한 내용 다시 보기> > <단어시험 다시 보기>\n\n월요일에 새 단어가 또 들어오니까,\n그 전에 한 번 훑어두면 머리가 훨씬 가벼워요!\n(이미 인증을 완료한 후라면, 인증에는 영향을 주지 않습니다)'],
  ['day 07', '단어 복습 리마인드 ③ (Day 7 · 출퇴근 활용)', '양 톡방 · Day 07 저녁 · 버디 · 복습 리마인드 시리즈', '단어가 슬슬 많아졌죠? 😅\n이럴 때 제일 좋은 게 <b>자투리 시간 복습</b>이에요.\n\n출근길에 한 번, 퇴근길에 한 번!\n스피커 버튼 눌러서 발음까지 같이 들으시면 더 좋아요 🔊\n\n앱 [내 학습] > 맨 아래 > <오늘 인증한 내용 다시 보기> > <단어시험 다시 보기>\n(이미 인증을 완료한 후라면, 인증에는 영향을 주지 않습니다)'],
  ['day 11', '단어 복습 리마인드 ④ (Day 11 · 3주차 고비)', '양 톡방 · Day 11 저녁 · 버디 · 복습 리마인드 시리즈', '여러분.. 이제 슬슬 단어가 많아졌죠?\n이럴 때는 많이 복습하는 게 최고예요!!!\n단어시험을 아침, 저녁으로 한 번 다시 보세요~~\n(이미 인증을 완료한 후라면, 인증에는 영향을 주지 않습니다)\n\n앱 [내 학습] > 맨 아래 > <오늘 인증한 내용 다시 보기> > <단어시험 다시 보기>\n수시로 봐주세요!'],
  ['day 14', '단어 복습 리마인드 ⑤ (Day 14 · 파이널 대비)', '양 톡방 · Day 14 저녁 · 버디 · 복습 리마인드 시리즈', '슬슬 마지막 주가 보이기 시작하네요 :)\n파이널 테스트는 <b>Day 1~20 전체</b>에서 나와요.\n\n지금부터 하루 두 번씩만 훑어두시면\n마지막 주에 몰아서 하는 일이 없어집니다 ㅎㅎ\n\n앱 [내 학습] > 맨 아래 > <오늘 인증한 내용 다시 보기> > <단어시험 다시 보기>\n(이미 인증을 완료한 후라면, 인증에는 영향을 주지 않습니다)'],
  ['day 18', '단어 복습 리마인드 ⑥ (Day 18 · 마무리)', '양 톡방 · Day 18 저녁 · 버디 · 복습 리마인드 시리즈', '이제는 좀 지겹죠..? ㅋㅋㅋ\n그래도 마지막으로 한 번만 더 말씀드릴게요!\n\n아침, 저녁으로 단어 복습 해주세요~\n지겨워질 때쯤 진짜로 외워지는 거거든요 :)\n\n앱 [내 학습] > 맨 아래 > <오늘 인증한 내용 다시 보기> > <단어시험 다시 보기>\n(이미 인증을 완료한 후라면, 인증에는 영향을 주지 않습니다)\n\n여기까지 오신 것만으로 이미 대단하십니다 🧡'],
...
// 단어 복습 리마인드 행 (2026-08-24): Day 3/5/7/11/14/18 저녁에 한 번씩.
// 같은 말 반복이 아니라 6개 원고가 전부 다른 톤이다 (습관 심기 → 주말 → 자투리 → 고비 → 파이널 → 마무리).
function addVocabReviewRows() {
  const sh = SpreadsheetApp.getActiveSpreadsheet().getSheetByName(CHECK_SHEET);
  const T = '단어 복습 리마인드 발송 (아침·저녁 단어시험 다시 보기)';
  const targets = [3, 5, 7, 11, 14, 18];

  const last = sh.getLastRow();
  const tasks = sh.getRange(6, 6, last - 5, 1).getDisplayValues().map(function (r) { return String(r[0] || ''); });
  if (tasks.indexOf(T) >= 0) { Logger.log('이미 있어요.'); return; }

  const days = sh.getRange(6, 1, last - 5, 1).getDisplayValues();
  let cur = 0; const endRow = {};
  for (let i = 0; i < days.length; i++) {
    const m2 = String(days[i][0] || '').match(/Day\s*(\d+)/i);
    if (m2) cur = Number(m2[1]);
    if (cur) endRow[cur] = 6 + i;
  ...
  targets.sort(function (a, b) { return b - a; }).forEach(function (d) {
    ...
    sh.getRange(r + 1, 6).setValue(T);
  });
  refreshChecklist();
  Logger.log('복습 리마인드 행 ' + targets.length + '개 추가');
}
